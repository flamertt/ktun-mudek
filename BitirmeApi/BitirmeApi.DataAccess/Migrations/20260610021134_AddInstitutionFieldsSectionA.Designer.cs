...
namespace BitirmeApi.DataAccess.Migrations
{
    ...
    [Migration("20260610021134_AddInstitutionFieldsSectionA")]
    partial class AddInstitutionFieldsSectionA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.CloEvaluationResult", b =>
                {
                    ...
                    b.HasIndex("ExternalCourseOfferingId", "ExternalCloId", "ResultType")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.ExamEvaluationResult", b =>
                {
                    ...
                    b.HasIndex("ExternalCourseOfferingId", "ExamId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.ExamQuestionEvaluationResult", b =>
                {
                    ...
                    b.HasIndex("ExternalCourseOfferingId", "AssessmentComponentId")
                        .IsUnique()
                        .HasFilter("[AssessmentComponentId] IS NOT NULL");

                    b.HasIndex("ExternalCourseOfferingId", "ExamQuestionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.LetterGradeRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExternalProgramId", "LetterGrade")
                        .IsUnique();

                    b.ToTable("LetterGradeRules", t =>
                        {
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.ProgramOutcomeContribution", b =>
                {
                    ...
                    b.HasIndex("CourseEvaluationId", "ExternalCloId", "ProgramOutcomeCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.ProgramOutcomeEvaluationResult", b =>
                {
                    ...
                    b.Property<int>("ExternalProgramOutcomeId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProgramOutcomeTitle")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("ExternalCourseOfferingId", "ExternalProgramOutcomeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.StudentAnswer", b =>
                {
                    ...
                    b.HasIndex("ExamQuestionId", "ExternalStudentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.StudentAssessmentComponentScore", b =>
                {
                    ...
                    b.HasIndex("AssessmentComponentId", "ExternalStudentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.StudentEvaluationResult", b =>
                {
                    ...
                    b.Property<string>("ExternalStudentName")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ExternalStudentNumber")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("ExternalCourseOfferingId", "ExternalStudentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BitirmeApi.Entity.Entities.Submission", b =>
                {
                    ...
                    b.HasIndex("SurveyId", "ExternalStudentId")
                        .IsUnique();
